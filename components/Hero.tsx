...
const Hero = (props: Props) => {
  return (
    <div className="pb-20 pt-36">
      ...
      <div
        className="h-screen w-full bg-white bg-grid-black/[0.1] 
      ...
      <div className="flex justify-center relative my-20 z-10">
        ...
        >
          ...
          >
            I&apos;m Bashir Salisu Sidi, a Senior React.js/Next.js/Nodejs Developer Engineer based
            in Nigeria.
          </p>
